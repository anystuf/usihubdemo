export const demoData = {
  ...
  startups: [
    ...
    {
      id: "rang-ro-viet-nam",
      name: "RẠNG RỠ VIỆT NAM",
      cohort: "UII 2025",
      stage: "Angel",
      sector: "EdTech / Cultural technology",
      risk: "Medium",
      health: 70,
      founderNeed: "Cultural product validation, education partnerships, distribution",
      summary: "Tech-integrated board game preserving Vietnamese ethnic culture through interactive learning.",
      traction: "Directory profile identifies an early-stage cultural education product with a clear local identity.",
      nextAction: "Pilot the board game with schools and cultural organizations, then measure repeat use and learning outcomes.",
      sources: ["UEH UII Startup Directory"],
      sourceUrl: "https://uii.ueh.edu.vn/en/innovation-pathway/uii-incubation-program/startup-directory/",
      tags: ["cultural technology", "education", "board game"],
      missingData: ["Pilot school", "Learning outcome evidence", "Distribution plan"]
    },
    {
      id: "smart-3d-tour-ai",
      name: "SMART 3D TOUR TÍCH HỢP AI",
      cohort: "UII 2025",
      stage: "Seed",
      sector: "Digital transformation",
      risk: "Medium",
      health: 69,
      founderNeed: "Tourism partnerships, analytics validation, enterprise sales",
      summary: "AI-integrated 3D tour platform with behavioral analytics for richer digital experiences.",
      traction: "Directory profile places the product at Seed stage with a digital transformation focus.",
      nextAction: "Secure one tourism or real-estate pilot and define engagement and conversion metrics.",
      sources: ["UEH UII Startup Directory"],
      sourceUrl: "https://uii.ueh.edu.vn/en/innovation-pathway/uii-incubation-program/startup-directory/",
      tags: ["3D tour", "AI", "analytics"],
      missingData: ["Pilot customer", "Conversion baseline", "Enterprise pricing"]
    },
    {
      id: "niion-biomass-energy",
      name: "NIION BIOMASS ENERGY",
      cohort: "UII 2025",
      stage: "Angel",
      sector: "Agritech / Clean energy",
      risk: "High",
      health: 56,
      founderNeed: "Unit economics, supply stability, buyer validation",
      summary: "Eco-friendly biomass briquettes recycled from garlic waste.",
      traction: "Directory profile highlights a circular-economy product using agricultural waste as feedstock.",
      nextAction: "Validate feedstock supply, production margin, and repeat purchase with one anchor buyer.",
      sources: ["UEH UII Startup Directory"],
      sourceUrl: "https://uii.ueh.edu.vn/en/innovation-pathway/uii-incubation-program/startup-directory/",
      tags: ["biomass", "circular economy", "clean energy"],
      missingData: ["Unit economics", "Anchor buyer", "Supply contract"]
    },
    {
      id: "airr-mattress",
      name: "AIRR MATTRESS",
      ...
      risk: "Medium",
      health: 64,
      founderNeed: "Consumer validation, product prototype, sleep wellness evidence",
      summary: "Smart mattress startup focused on sleep wellness and a better rest experience.",
      traction: "Directory profile lists the startup as an early-stage Canadian health and wellness concept.",
      nextAction: "Run a small user research sprint and document prototype, target segment, and willingness to pay.",
      sources: ["UEH UII Startup Directory"],
      sourceUrl: "https://uii.ueh.edu.vn/en/innovation-pathway/uii-incubation-program/startup-directory/",
      tags: ["sleep wellness", "consumer product", "smart hardware"],
      missingData: ["Prototype", "Target segment", "Willingness to pay"]
    },
    {
      id: "skyholic",
      name: "SKYHOLIC",
      ...
      risk: "High",
      health: 58,
      founderNeed: "UAV regulation, mapping pilot, B2B customer discovery",
      summary: "AI-powered VTOL UAV for surveying and mapping.",
      traction: "Directory profile describes an early-stage UAV concept for surveying and mapping use cases.",
      nextAction: "Define one permission-ready mapping pilot and validate the first institutional buyer.",
      sources: ["UEH UII Startup Directory"],
      sourceUrl: "https://uii.ueh.edu.vn/en/innovation-pathway/uii-incubation-program/startup-directory/",
      tags: ["UAV", "AI", "mapping"],
      missingData: ["Pilot permission", "Institutional buyer", "Safety evidence"]
    }
  ],
  aiInsights: [
    {
  ...
  contacts: [
    { id: "contact-mentor-growth", name: "Growth Mentor A", type: "Mentor", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=160&q=80", contact: "growth-mentor@demo.invalid", expertise: ["B2B SaaS growth", "Customer success", "Pricing"], sector: "Ecommerce SaaS", availability: "This week", matchFor: ["Venture Epsilon"], notes: "Useful for onboarding, expansion channels, and customer success playbooks." },
    { id: "contact-uav-reg", name: "Regulated Tech Expert", type: "Expert", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=160&q=80", contact: "regulated-tech@demo.invalid", expertise: ["UAV regulation", "Pilot safety", "Government sales"], sector: "AI / UAV", availability: "Next week", matchFor: ["Venture Alpha"], notes: "Best fit for pilot permission path and risk assessment." },
    { id: "contact-market-validation", name: "Market Validation Trainer", type: "Trainer", image: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=160&q=80", contact: "validation-trainer@demo.invalid", expertise: ["Buyer interviews", "Unit economics", "Product focus"], sector: "Agritech / Clean energy", availability: "This week", matchFor: ["Venture Beta"], notes: "Can help narrow the hero product and validation sprint." },
    { id: "contact-marketplace", name: "Marketplace Operator", type: "Mentor", image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=160&q=80", contact: "marketplace-mentor@demo.invalid", expertise: ["Venue onboarding", "Marketplace liquidity", "Community activation"], sector: "Sports platform", availability: "Flexible", matchFor: ["Venture Gamma"], notes: "Supports supply-side onboarding and activation metrics." },
    { id: "contact-healthtech", name: "HealthTech Advisor", type: "Expert", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=160&q=80", contact: "healthtech-advisor@demo.invalid", expertise: ["Medical validation", "Legal/IP", "B2B buyer discovery"], sector: "HealthTech / MedTech", availability: "Next week", matchFor: ["Venture Zeta"], notes: "Review validation claims and buyer segmentation." }
  ],
  documents: [
    ...
    { title: "Value Proposition Design", type: "Book", startup: "Platform", tags: ["value proposition", "customer discovery", "strategyzer"], indexed: "Ready", source: "Strategyzer official library", url: "https://www.strategyzer.com/library/value-proposition-design" },
    { title: "Testing Business Ideas", type: "Book", startup: "Platform", tags: ["experimentation", "validation", "lean startup"], indexed: "Ready", source: "Wiley official publisher page", url: "https://www.wiley.com/en-us/Testing+Business+Ideas%3A+A+Field+Guide+for+Rapid+Experimentation-p-9781119551447" },
    { title: "Disciplined Entrepreneurship", type: "Book", startup: "Platform", tags: ["customer discovery", "startup framework", "MIT"], indexed: "Ready", source: "MIT Press official publisher page", url: "https://mitpress.mit.edu/9780262536085/disciplined-entrepreneurship/" }
  ],
  questions: [
    {
